...
<head>
    ...
    <title>Laravel DB Connection Testing</title>
</head>
<body>
    <div>
        <?php
            ...
            // Vektor A, B, dan C
            $input1 = ["Nasi", "Ayam", "Bayam", "Jeruk", "Poultry", "Vendor3"];
            $input2 = ["Mie", "Sapi", "Kol", "Pisang", "Meat", "Vendor2"];
            $target = ["Nasi", "Sapi", "Sawi", "Pisang", "Meat", "Vendor3"];
            ...
            // Tampilkan hasil
            echo "Cosine Similarity (A, C): " . round($cosineAC, 2) . PHP_EOL;
            echo "Cosine Similarity (B, C): " . round($cosineBC, 2) . PHP_EOL;
        ?>
    </div>
</body>
</html>
